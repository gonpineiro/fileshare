...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert(['name' => 'Gonzalo','email' => 'gon.pineiro@gmail.com','password' => Hash::make('admin'),'api_token' => 'XRyK4IaqEeCVvmS4aQBtz5AaI2nrh06YdYrgZ8FSyoE0Kl88099sBmZUjHCX']);
